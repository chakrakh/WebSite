                        ...
                        <tr>
                            {product.comparison_table ? (
                                product.comparison_headers.map((header, hIndex) => (
                                    <th key={hIndex} className={`px-6 py-3 text-left text-xs font-bold uppercase tracking-wider ${hIndex === 2 ? 'text-primary' : 'text-muted-foreground'}`}>
                                    {header}
                                    </th>
                                ))
                            ) : (
                                ...
                                <th className="px-6 py-3 text-left text-xs font-bold text-primary uppercase tracking-wider">Suryagatra</th>
                                </>
                            )}
                        </tr>
                      </thead>
                        ...
                        {product.comparison_table ? (
                            ...
                            <>
                             <tr className="hover:bg-muted/30 transition-colors">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-primary">5-30 mL</td>
                            </tr>
                            <tr className="hover:bg-muted/30 transition-colors">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-primary">24 Hours</td>
                            </tr>
                            </>
                        )}
                      </tbody>
